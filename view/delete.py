...
class Delete(QtWidgets.QWidget):
    ...
    def __init__(self, window):
        ...
        minlike = self.findChild(QtWidgets.QLineEdit, "minlikeLineEdit")
        minlike.setValidator(QtGui.QIntValidator(0, 10000))
        mincomment = self.findChild(QtWidgets.QLineEdit, "mincommentLineEdit")
        mincomment.setValidator(QtGui.QIntValidator(0, 10000))
        minlikeCheckBox = self.findChild(QtWidgets.QCheckBox, "minlikeCheckBox")
        mincommentCheckBox = self.findChild(QtWidgets.QCheckBox, "mincommentCheckBox")
        minlikeCheckBox.stateChanged.connect(lambda: minlike.setEnabled(minlikeCheckBox.isChecked()))
        minlike.setEnabled(minlikeCheckBox.isChecked())
        mincommentCheckBox.stateChanged.connect(lambda: mincomment.setEnabled(mincommentCheckBox.isChecked()))
        mincomment.setEnabled(mincommentCheckBox.isChecked())
